package com.example.xylav.webviewcache.util;
...
public class WebViewHelper {
    ...
    //配置webview的缓存目录
    public void setWebViewConfig(@NonNull WebView mWebView, String path) {
        //设置缓存路径
    ...
    public static void setWebViewCachePath(@NonNull WebView mWebView) {
        ...
        //         + APP_CACHE_DIRNAME;
        String cacheDirPath = path + APP_CACHE_DIRNAME;
